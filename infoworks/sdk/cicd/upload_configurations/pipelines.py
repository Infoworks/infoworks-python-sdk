...
class Pipeline:
    ...
    def create(self, pipeline_client_obj, domain_id, domain_name):
        ...
        if "description" in self.configuration_obj["configuration"].get("pipeline_configs", {}):
            pipeline_json_object["description"] = self.configuration_obj["configuration"].get("pipeline_configs", {}).get("description")
