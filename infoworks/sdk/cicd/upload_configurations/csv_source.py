...
class CSVSource:
    ...
    def create_csv_source(self, src_client_obj):
        ...
        if data.get("target_catalog_name", ""):
            create_csv_source_payload["target_catalog_name"] = data.get("target_catalog_name", "")
        if data.get("staging_catalog_name", ""):
            create_csv_source_payload["staging_catalog_name"] = data.get("staging_catalog_name", "")
        if data.get("profile", ""):
            create_csv_source_payload["profile"] = data.get("profile", "")
        utils_obj = Utils()
        utils_obj.replace_custom_tags_names_with_mapping(create_csv_source_payload, src_client_obj)
